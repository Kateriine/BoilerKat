...
//JS
var js = ['js/uikit.js', 'js/components/form-select.js', 'js/videojs/video.js', 'js/fancybox.js', 'js/site.js'],
...
gulp.task('prod', ['compress', 'scssCompressed', 'imagemin', 'watchprod']);
